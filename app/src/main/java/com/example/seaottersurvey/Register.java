...
public class Register extends AppCompatActivity {
    ...
    EditText etName, etMail, etPassword, etRetype;
    Button btnRegister;
            ...
            public void onClick(View v) {
                ...
                else
                {
                    if (etPassword.getText().toString().trim().equals(etRetype.getText().toString().trim()))
                    {
                        ...
                        //user.setProperty("email", "rdorrity@gmail.com");
                        //user.setProperty("name", "Ryan");
                        //user.setPassword("test123");

                        user.setProperty("email", etMail.getText().toString().trim());
                        ...
                        Backendless.UserService.register(user, new AsyncCallback<BackendlessUser>()
                        {
                            ...
                            {
                                Toast.makeText(Register.this, "New user registered successfully", Toast.LENGTH_SHORT).show();
                                //dialog.dismiss()
                            }
